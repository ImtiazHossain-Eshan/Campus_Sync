  ...
  <div class="bg-white shadow-xl rounded-3xl overflow-hidden">
    <div class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-8 text-white relative">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="edit_profile.php" class="inline-flex items-center bg-white text-blue-700 px-5 py-2 rounded-full font-semibold hover:bg-blue-100 transition shadow-md">
          ✏️ Edit Profile
        </a>
      </div>
    </div>
